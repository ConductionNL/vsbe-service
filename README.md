...
Description
----
The very small business engine (VSBE) is used to immediately tap into the business logic of another service / component for specific API calls.

The VSBE consists of rules that determine if and if so what is done when a specific API call is made.
